...
class Admin extends BaseController
{
    ...
    public function dashboard()
    {
        ...
        $totalSiswa = $user->getTotalUser('Sekolah');
        $totalMahasiswa = $user->getTotalUser('Universitas');
    ...
    public function data_siswa()
    {
        ...
        $dataSiswa = $user->where('instansi_pendidikan', 'Sekolah')->findAll();
        $nomor = nomor($currentPage, $jumlahBaris);
    ...
    public function data_mahasiswa()
    {
        ...
        $dataMahasiswa = $user->where('instansi_pendidikan', 'Universitas')->paginate($jumlahBaris, 'mahasiswa');
    ...
    function tambahUser()
    {
        ...
        $aturan = [
            ...
            'no_hp' => [
                'rules' => 'required|is_unique[member.no_hp]',
                'errors' => [
    ...
    function editUserModal()
    {
        ...
        $validasi->setRules($aturan);
        if ($validasi->withRequest($this->request)->run()) {
            $nama_lengkap = $this->request->getPost('edit_nama_lengkap');
