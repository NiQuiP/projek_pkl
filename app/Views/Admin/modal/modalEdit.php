    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close tombol-tutup-edit" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select name="edit_gender" class="form-control" id="editGender" onchange="updateValueG()">
                ...
                <div class="mb-3">
                    ...
                    <select name="edit_instansi" class="form-control" id="editInstansi" onchange="updateValueI()">
                        <option value="" hidden></option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary tombol-tutup-edit" data-bs-dismiss="modal">Tutup</button>
